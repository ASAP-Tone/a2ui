...
SALESFORCE_AGENT_URL = "https://adk-salesforce-service-39067166180.us-central1.run.app"

async def main() -> None:

    # remote testing
    base_url = SALESFORCE_AGENT_URL
    ...
    async with httpx.AsyncClient(timeout=timeout) as httpx_client:
        ...
        # Use a query relevant to Salesforce
