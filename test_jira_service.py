...
JIRA_AGENT_URL = "https://adk-jira-service-39067166180.us-central1.run.app"


async def main() -> None:

    # remote testing
    base_url = JIRA_AGENT_URL
    ...
    async with httpx.AsyncClient(timeout=timeout) as httpx_client:
        ...
        # Use a more specific query to test the agent's tools
